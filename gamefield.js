...
//------------------------------------ конец beginerMove
 ...
 function getIDSquare(clickPageX,clickPageY ){
  ...
  // после второго вызова  legalyPos
     var testABC= Object.keys (nextStepObj.posFigure);
         ...
         if( (posForStepArr.length<=1) ) {
            ...
            else if( (testABC.length==2) && 
            ( (posForStepArr[0] in about.arrFigure)==true) && ( (posForStepArr[1] in about.arrFigure)==false) &&
            (nextStepObj.colorFigure!=about.arrFigure[posForStepArr[0]].color)
            ){
            ...
            (nextStepObj.colorFigure!=about.arrFigure[posForStepArr[1]].color))
            ){
